...
export default function Page() {
    ...
    return mounted && (
        <>
            ...
            <InnerBanner img={BannerImg} title="User Login" des="Login Or Sign Up" />


            <div className="p-10">
                <div className="container">
                    <div className='text-end mb-2'><Link href='/business-login' className='btn btn-lg btn-primary'>Business Account</Link></div>
                    <div className="row justify-content-center mb-5">
                        <div className="col-md-11 col-lg-9 col-xl-8  text-center">
                    ...
                    <div className="row">
                        <div className="col-md-6 mb-5">
                            <h3 className='text-center text-uppercase fw-medium mb-3'>USER LOGIN</h3>
