        ...
        <>
            ...
            <div className="p-10">
                <div className="container">
                    ...
                    <h2 class="text-center text-uppercase">Accounts</h2>
                    ...
                    <h2 class="text-center text-uppercase">Prohibited uses</h2>
                    ...
                    <h2 class="text-center text-uppercase"><span class="text-uppercase">Damages and limitation of liability</span></h2>

                    <p class="text-uppercase">In no event shall Brewery Hours be liable for any direct, indirect, punitive, incidental, special or consequential damages arising out of, relating to or in any way connected with your access to, display of or use of this Application or with the delay or inability to access, display or use this Application, including but not limited to your reliance upon opinions or information appearing on this Application; any computer viruses, information, software, linked websites operated by third parties, products or services obtained through this Application, whether based on a theory of negligence, contract, tort, strict liability, consumer protection statutes or otherwise, even if Brewery Hours has been advised of the possibility of such damages. </p><h2 class="text-center text-uppercase">Links to third party websites</h2>
                    ...
                    <h2 class="text-center text-uppercase">Intellectual property and DMCA notice and procedure for intellectual property infringement claims</h2>
                    ...
                    <h2 class="text-center text-uppercase">Governing law, severability, dispute resolution and venue</h2>
                    ...
                    <p class="text-uppercase">You and Brewery Hours agree that each may bring claims against the other only in your or its individual capacity and not as a plaintiff or class member in any class or representative action.</p>

                    <h2 class="text-center text-uppercase">Changes to Terms of Service</h2>
                    ...
                    <h2 class="text-center text-uppercase">Questions</h2><p>If you have any questions about our Terms of Service, please contact us at info@breweryhours.com.</p>
