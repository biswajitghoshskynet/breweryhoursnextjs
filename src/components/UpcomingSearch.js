                        ...
                        <form action="">
                            <div className='d-md-flex gap-2'>
                                <div className='mb-1 flex-fill'>
                                    <input className='form-control' type="text" name='name' id='name' placeholder='BY NAME' />
                                </div>
                                <div className='mb-1 flex-fill'>
                                    <input className='form-control' type="text" name='name' id='name' placeholder='BY KEYWORD' />
                                </div>
                                <div className='mb-1 flex-fill'>
